...
$currentMemberId = $form['member_id'] ?? '';
$currentRoleId   = $form['role_id'] ?? '';
$currentStatus   = $form['status'] ?? 'Active';
...
<div class="page-header">
    ...
    <div>
        ...
        <a
            href="<?= config('app.base_path') ?>/staff/<?= (int) $staff['id'] ?>"
...
<div class="card">
    ...
    <form
        method="POST"
        action="<?= config('app.base_path') ?>/staff/<?= (int) $staff['id'] ?>/update"
    >
